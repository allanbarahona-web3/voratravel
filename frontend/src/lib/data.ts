...
export const insurancePlans: InsurancePlan[] = [
  {
    ...
    description: {
      es: 'Cobertura esencial para viajes cortos',
      en: 'Essential coverage for short trips',
    },
    pricePerDay: 3.5,
    maxCoverage: 50000,
    recommended: false,
    features: {
      es: [
        'Emergencia médica hasta $50,000',
  ...
  },
  {
    ...
    description: {
      es: 'Ideal para viajes de 1-3 semanas, el más popular',
      en: 'Ideal for 1-3 week trips, the most popular',
    },
    pricePerDay: 6.5,
    maxCoverage: 150000,
    recommended: true,
    features: {
      es: [
        ...
        'COVID-19 incluido',
        'Deportes de aventura básicos',
        'App de asistencia multilingüe',
      ],
      en: [
        ...
        'Civil liability up to $50,000',
        'COVID-19 included',
        'Basic adventure sports',
        'Multilingual assistance app',
      ],
    },
  },
  {
    ...
    description: {
      es: 'Protección total para viajeros exigentes',
      en: 'Total protection for demanding travelers',
    },
    pricePerDay: 12,
    maxCoverage: 500000,
    recommended: false,
